      ...
      {orders.map((o, i) => {
        ...
        return (
          ...
          >
            <Link
              href={o.href}
              className={`group relative flex items-center gap-4 overflow-hidden rounded-2xl border px-5 py-4 transition-colors ${o.cancellable ? "pr-44" : ""} ${
                o.cancelled
            ...
            >
              ...
              <span className="min-w-0 flex-1">
                ...
                <span className="mt-2 block h-1.5 overflow-hidden rounded-full bg-surface-tertiary">
                  <motion.span
                    className={`block h-full rounded-full ${o.failed ? "bg-danger" : o.cancelled ? "bg-border-tertiary" : "bg-accent"}`}
                    initial={{ width: 0 }}
            ...
            {o.cancellable ? (
              <div className="absolute right-12 top-1/2 -translate-y-1/2">
                <CancelOrder id={o.id} back="home" compact />
              </div>
            ) : null}
          </motion.div>
        );
