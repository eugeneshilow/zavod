# Лицензии медиа историй

Каждая картинка и каждое видео в `content/reels/media/<id>/` имеет здесь строку:
`файл · источник (URL) · лицензия · дата`. Файл без строки в ролик не идёт —
это проверяет сам рендер (`scripts/reels/render-story.mjs`). Канон зоны —
[docs/reels.md](../../../docs/reels.md), раздел «История».

## robot-knife

`robocurve-roboharm.mp4` · https://x.com/chooi_jeq/status/2101118049944543545 (Jay Chooi, Robocurve, видео бенчмарка) · цитирование источника новости с указанием автора · 2026-09-20
`propane-cylinder.jpg` · https://commons.wikimedia.org/wiki/File:Propane_cylinder_type_2012_in_Tuntorp_2.jpg (W.carter) · CC BY-SA 4.0 · 2026-09-20
